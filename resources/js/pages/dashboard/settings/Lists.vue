    ...
    <Container>
        ...
        <Card>
            <template #content>
                ...
                <DataTable :value="lists" paginator :rows="10" dataKey="id" stripedRows responsiveLayout="scroll">
                    <Column field="name" header="List Name" sortable></Column>

                    <!-- Στήλη προβολής του ενεργού Cover -->
                    <Column header="Cover">
                        <template #body="slotProps">
                            <img :src="slotProps.data.resolved_cover || '/images/placeholder.png'"
                                :alt="slotProps.data.name" class="w-16 h-16 object-cover rounded shadow-sm" />
                        </template>
                    </Column>
