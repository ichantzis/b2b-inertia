...
import { mergeProps, useSSRContext, createSSRApp, h as h$1, ref } from "vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(_attrs)}><div class="flex items-end justify-between flex-wrap gap-2 md:gap-4"><div><h1 class="font-bold text-2xl md:text-3xl leading-tight">`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/PageTitleSection.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const PageTitleSection = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
...
const appName = "Pinakothiki";
createServer(
  (page) => createInertiaApp({
    page,
    render: renderToString,
    title: (title) => `${title} - ${appName}`,
    resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Artists.vue": () => import("./assets/Artists-IrQikp1m.js"), "./pages/ArtworkDetails.vue": () => import("./assets/ArtworkDetails-DaNNOcT6.js"), "./pages/Artworks.vue": () => import("./assets/Artworks-CWbRPmJz.js"), "./pages/ByCategoryPage.vue": () => import("./assets/ByCategoryPage-BOAwZOD7.js"), "./pages/Cart.vue": () => import("./assets/Cart-21p0smHo.js"), "./pages/Checkout.vue": () => import("./assets/Checkout-C4je35AJ.js"), "./pages/CheckoutComplete.vue": () => import("./assets/CheckoutComplete-Ce7DKqL_.js"), "./pages/Collections.vue": () => import("./assets/Collections-D0cwROSd.js"), "./pages/Contact.vue": () => import("./assets/Contact-CB39Y0V0.js"), "./pages/Lists.vue": () => import("./assets/Lists-CMx3sYkD.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-reSdLbRz.js"), "./pages/account/Addresses.vue": () => import("./assets/Addresses-CXaXCK--.js"), "./pages/account/OrderDetails.vue": () => import("./assets/OrderDetails-BsCZUNiS.js"), "./pages/account/Orders.vue": () => import("./assets/Orders-tYZQmrnd.js"), "./pages/account/profile/Edit.vue": () => import("./assets/Edit-CWTl2qvM.js"), "./pages/account/profile/partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-CWU8xXw8.js"), "./pages/account/profile/partials/UpdateAddressForm.vue": () => import("./assets/UpdateAddressForm-VqUOpUgt.js"), "./pages/account/profile/partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-6SNopN85.js"), "./pages/account/profile/partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-CoNIgpQP.js"), "./pages/artists/Index.vue": () => import("./assets/Index-Dm1xsqun.js"), "./pages/artists/Overview.vue": () => import("./assets/Overview-C3pfbC_l.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-DnK_djMf.js"), "./pages/auth/Login.vue": () => import("./assets/Login-CxvRBn-D.js"), "./pages/auth/Register.vue": () => import("./assets/Register-_KT2Tpta.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-mzT0tbig.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-BukakuIx.js"), "./pages/dashboard/Dashboard.vue": () => import("./assets/Dashboard-DbYvwOyh.js"), "./pages/dashboard/Settings.vue": () => import("./assets/Settings-A4fW1Hve.js"), "./pages/dashboard/coupons/Create.vue": () => import("./assets/Create-J2XVDcy-.js"), "./pages/dashboard/coupons/Index.vue": () => import("./assets/Index-Bxyzn3B9.js"), "./pages/dashboard/orders/Index.vue": () => import("./assets/Index-DfGiqibD.js"), "./pages/dashboard/orders/Show.vue": () => import("./assets/Show-C9IB0oHF.js"), "./pages/dashboard/users/Create.vue": () => import("./assets/Create-D54fmQP9.js"), "./pages/dashboard/users/Edit.vue": () => import("./assets/Edit-DQNtX-KS.js"), "./pages/dashboard/users/Index.vue": () => import("./assets/Index-6QJuqMxq.js"), "./pages/dashboard/users/Partials/UserForm.vue": () => import("./assets/UserForm--1n_WD30.js") })),
    setup({ App, props, plugin }) {
      ...
      }).use(ToastService).use(ConfirmationService).provide("darkMode", ref(false)).component("InertiaHead", Head).component("InertiaLink", Link).component("Container", _sfc_main$1).component("PageTitleSection", PageTitleSection);
    }
  })
);
export {
  PageTitleSection as P,
  _export_sfc as _,
  _sfc_main$1 as a
};
