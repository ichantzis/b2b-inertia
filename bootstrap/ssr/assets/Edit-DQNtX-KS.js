        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), {
              title: `Admin - Edit ${__props.user.name}`
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$1, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="max-w-4xl mx-auto"${_scopeId2}><div class="flex items-center justify-between mb-6"${_scopeId2}><h1 class="text-2xl font-semibold text-gray-800"${_scopeId2}>Edit User: ${ssrInterpolate(__props.user.name)}</h1></div><div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$2, {
                    user: __props.user,
                    "user-roles": __props.userRoles,
                    action: _ctx.route("dashboard.users.update", __props.user.id),
                    method: "put"
                  ...
                  return [
                    createVNode("div", { class: "max-w-4xl mx-auto" }, [
                      createVNode("div", { class: "flex items-center justify-between mb-6" }, [
                        createVNode("h1", { class: "text-2xl font-semibold text-gray-800" }, "Edit User: " + toDisplayString(__props.user.name), 1)
                      ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/dashboard/users/Edit.vue");
